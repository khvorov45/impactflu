...
// sim_reference_cpp
DataFrame sim_reference_cpp(const int init_pop_size, const IntegerVector& vaccinations, const IntegerVector& infections_novac, const IntegerVector& deaths_novac, const NumericVector& ve, const int lag, const int dur, const bool deterministic);
RcppExport SEXP _impactflu_sim_reference_cpp(SEXP init_pop_sizeSEXP, SEXP vaccinationsSEXP, SEXP infections_novacSEXP, SEXP deaths_novacSEXP, SEXP veSEXP, SEXP lagSEXP, SEXP durSEXP, SEXP deterministicSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const int >::type init_pop_size(init_pop_sizeSEXP);
    ...
    Rcpp::traits::input_parameter< const IntegerVector& >::type deaths_novac(deaths_novacSEXP);
    Rcpp::traits::input_parameter< const NumericVector& >::type ve(veSEXP);
    Rcpp::traits::input_parameter< const int >::type lag(lagSEXP);
    Rcpp::traits::input_parameter< const int >::type dur(durSEXP);
    Rcpp::traits::input_parameter< const bool >::type deterministic(deterministicSEXP);
    rcpp_result_gen = Rcpp::wrap(sim_reference_cpp(init_pop_size, vaccinations, infections_novac, deaths_novac, ve, lag, dur, deterministic));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_impactflu_sim_reference_cpp", (DL_FUNC) &_impactflu_sim_reference_cpp, 8},
    {NULL, NULL, 0}
};
